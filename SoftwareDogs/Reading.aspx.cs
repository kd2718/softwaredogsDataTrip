...
namespace SoftwareDogs
{
    public partial class Reading : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (null == Session["myDataSet"])
                {
                    ...
                    string strCommand = "SELECT iReadingKey, datDateTime, dValue, iUnitKey, iTypeKey FROM vReading ORDER BY datDateTime";
        ...
        protected void gData_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("DELETE FROM tReading WHERE iReadingKey = " + aiKey[e.RowIndex], conConnection);
        ...
        protected void gData_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (iReading > 0)
            {
                ...
                if (i < 0)
                {
                    ...
                    {
                        sSQL = "UPDATE tReading SET acName='" + sName.Replace("'", "''") + "',iReadingNumber=" + iReading.ToString() + " WHERE iReadingKey=" + aiKey[iRow];
                    }
